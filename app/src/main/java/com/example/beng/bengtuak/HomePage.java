...
public class HomePage extends AppCompatActivity {
    ...
    private static final String url = "https://" + host + "/v1/people/~:" + "(email-address,formatted-name,picture-url)";
    ...
    public  void  showResult(JSONObject response){
        ...
        try {
            ...
            Picasso.with(this).load(response.get("pictureUrl").toString()).into(profile_picture);
